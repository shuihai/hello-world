...
//    val date1 = LocalDate.parse("31-Dec-13", formatter)
//    println(date1)
//    val format = new SimpleDateFormat("dd-MMM-yy",Locale.ENGLISH)
//    val date =format.parse("31-Dec-13")
//    println(date)
...
//    plotDistribution(factorsReturns(3))
  ...
  def readStocksAndFactors(prefix: String): (Seq[Array[Double]], Seq[Array[Double]]) = {
    ...
    val stocksDir = new File("E://stocks/")
