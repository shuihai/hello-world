...
<input type="hidden" name="img[]" value="111.jpg" class="old_1 hehe">
<input type="hidden" name="img[]" value="222.jpg" class="old_2 hehe">
<input type="hidden" name="img[]" value="333.jpg" class="old_3  hehe">
    </form>
