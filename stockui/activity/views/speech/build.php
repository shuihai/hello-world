                                ...
                                <div class="question">
                                    ...
                                    if ($voice_id > 0) {
                                        foreach ($voice_question as $key => $value) {
                                            ?>
                                            <p>
                                                <input type="text" id="" class="question_q" maxlength="30" placeholder="请输入30字以内的问句" value="<?= Html::encode($value['question']) ?>" q_num="<?= Html::encode($value['id']) ?>"/>
                                                <i class="delImg"></i>
                                            </p>
                                            <?php
                                        }
                                        ...
                                        ?>  
                                        <p>
                                            <input type="text" id="" class="question_q" maxlength="30" placeholder="请输入30字以内的问句"/>
                                            <i class="delImg"></i>
                                        </p>
                                    <?php } ?>  
                                ...
                                <div class="answer">
                                    ...
                                    if ($voice_id > 0) {
                                        foreach ($voice_answer as $key => $value) {
                                            ?>
                                            <p>
                                                <input type="text" id="" class="answer_a" maxlength="30" placeholder="请输入30字以内的答句" value="<?= Html::encode($value['answer']) ?>" q_num="<?= Html::encode($value['id']) ?>"/>
                                                <i class="delImg"></i>
                                            </p>
                                            <?php
                                        }
                                        ...
                                        ?>  
                                        <p>
                                            <input type="text" id="" class="answer_a" maxlength="30" placeholder="请输入30字以内的答句"/>
                                            <i class="delImg"></i>
                                        </p>
                                    <?php } ?>  
